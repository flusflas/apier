import pytest
from templates.python.base.internal.content_type import parse_content_type, content_types_compatible
...
@pytest.mark.parametrize("type1, type2, expected", [
    ...
    ("application/vnd.api+json; charset=utf-8", "application/vnd.api+xml; charset=utf-8", False),
    ("application/vnd.api+json; version=1", "application/vnd.api+json; version=2", True),
    ("application/vnd.api+json; version=1", "application/vnd.api+xml; version=1", False),
